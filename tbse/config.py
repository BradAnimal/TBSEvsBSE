...
# Given 7 hours
virtualSessionLength = 25200  # Number of virtual timesteps per sessionLength.
...
timemode = 'drip-poisson'  # Valid values: 'periodic', 'drip-fixed', 'drip-jitter', 'drip-poisson'
